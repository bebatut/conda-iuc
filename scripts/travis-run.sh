...
if [[ $TRAVIS_BRANCH != "master" && $TRAVIS_BRANCH != "bulk" && $TRAVIS_PULL_REQUEST == "false" && $TRAVIS_REPO_SLUG == "galaxyproject/conda-iuc" ]]
then
    echo ""
    echo "Tests are skipped for pushes to the main conda-iuc repo."
